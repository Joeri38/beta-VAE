...
class Network(object):
    ...
    def graph_setup(self):
        ...
        with self.graph.as_default():
            ...
            # Define placeholders #
            #######################
            self.input = v1.placeholder(tf.float32, [None, self.input_size], name='input')
            self.epsilon = v1.placeholder(tf.float32, [None, self.latent_size], name='epsilon')
            self.learning_rate = v1.placeholder(tf.float32, shape=[], name='learning_rate')
            self.beta = v1.placeholder(tf.float32, shape=[], name='beta')
